...
(function() {
  const lines = [
    ...
    { text: '906 SUSPECTED  ·  240+ DEATHS  ·  105 CONFIRMED', cls: '' },
    { text: '', cls: '' },
...
(function() {
  ...
  const outbreakStatus = {
    'COD': { status: 'active',     label: 'DR Congo — ACTIVE OUTBREAK · WHO: VERY HIGH RISK', cases: '906 susp / 105 conf / 240+ dead · Ituri, North Kivu, South Kivu' },
