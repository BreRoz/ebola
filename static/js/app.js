...
(function() {
  ...
  const outbreakStatus = {
    'COD': { status: 'active',     label: 'DR Congo — ACTIVE OUTBREAK · WHO PHEIC', cases: '1,003 confirmed · 254 deaths · CFR 25% · CROSSED 1,000 CASES · Africa CDC: could be WORST EVER outbreak' },
