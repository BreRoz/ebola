...
(function() {
  ...
  const outbreakStatus = {
    'COD': { status: 'active',     label: 'DR Congo — ACTIVE OUTBREAK · WHO PHEIC', cases: '1,502 confirmed · 473 deaths · CFR 31% · WHO: highest first-month total of ANY Ebola outbreak in history' },
