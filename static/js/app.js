...
(function() {
  const lines = [
    ...
    { text: '1,000+ SUSPECTED  ·  246+ DEATHS  ·  105 CONFIRMED', cls: '' },
    { text: '', cls: '' },
...
(function() {
  ...
  const outbreakStatus = {
    'COD': { status: 'active',     label: 'DR Congo — ACTIVE OUTBREAK · WHO: VERY HIGH RISK', cases: '1,000+ susp / 105 conf / 246+ dead · Ituri, North Kivu, South Kivu' },
